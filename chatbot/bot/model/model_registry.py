...
from chatbot.bot.model.settings.deep_seek import DeepSeekR1SevenSettings
from chatbot.bot.model.settings.llama import (
    Llama31Settings,
    Llama31ToolSettings,
    Llama32OneSettings,
    Llama32ThreeSettings,
)
from chatbot.bot.model.settings.openchat import OpenChat35Settings, OpenChat36Settings
from chatbot.bot.model.settings.phi import Phi35Settings
from chatbot.bot.model.settings.qwen import (
...
from chatbot.bot.model.settings.stablelm_zephyr import StableLMZephyrSettings
